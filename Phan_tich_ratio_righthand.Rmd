...
draw_forest_plot <- function(results_table) {
  ...
  forestplot(labeltext = label_matrix_with_header, 
             ...
             title = paste("Forest plot of ", results_table$Subgroup, " Ratios in right hand", sep=""),
             zero = 1,  
             line.margin = .1,
             new_page = TRUE,
...
```{r}
variables <- c("M_right", "Kv100_right", "δ_right", "T_right", "A365_right", "A460_right", "Anadn_right", "POM_right", "A-E_right", "A-N_right", "A-M_right", "A-R_right", "A-C_right", "F-E_right", "F-N_right", "F-M_right", "F-R_right", "F-C_right")
